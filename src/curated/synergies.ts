...
export const SYNERGIES: readonly SkillEdge[] = [
  { a: 'vantage', b: 'vengeance', note: 'Vantage works below half HP, exactly when Vengeance hits hardest.', sources: ['S3', 'S4', 'S5', 'S6', 'S7', 'S10'] },
  { a: 'vengeance', b: 'wrath', note: 'Wrath adds +20 crit in the same low-HP state; a crit triples the Vengeance hit.', sources: ['S3', 'S4', 'S5', 'S10'] },
  { a: 'vantage', b: 'wrath', note: 'Both switch on below half HP.', sources: ['S3', 'S4', 'S5', 'S10'] },
  ...
  { a: 'luna', b: 'rightful-king', note: 'Rightful King is worth about one extra proc at Apotheosis Skl.', sources: ['S3', 'S4', 'S10'] },
  { a: 'aether', b: 'rightful-king', note: 'Rightful King adds a flat +10% to low-rate Aether.', sources: ['S3', 'S4', 'S6', 'S10'] },
  ...
  // S10 (#106): Ellery's combos.
  { a: 'hex', b: 'anathema', note: 'Two −15 Avoid auras stack, so everything near the pair gets hit.', sources: ['S10'] },
  { a: 'dual-support-plus', b: 'demoiselle', note: 'An aura back: more support bonus for the lead, less damage to nearby men.', sources: ['S10'] },
  { a: 'dual-support-plus', b: 'solidarity', note: 'An aura back: the lead’s support bonus and nearby allies’ crit and crit avoid.', sources: ['S10'] },
  { a: 'galeforce', b: 'aggressor', note: 'Aggressor’s +10 player-phase damage secures the kill Galeforce needs.', sources: ['S10'] },
  { a: 'avoid-plus-10', b: 'quick-burn', note: 'Evasion stack for a dodge tank, strongest early in the map.', sources: ['S10'] },
  { a: 'avoid-plus-10', b: 'lucky-seven', note: 'Evasion stack for a dodge tank, for the first seven turns.', sources: ['S10'] },
...
export const CONFLICTS: readonly SkillEdge[] = [
  ...
  // S10 (#106): Lunatic+ enemies carry Counter, and Astra's five hits each take Counter damage.
  { a: 'astra', b: 'counter', note: 'Five Astra hits into an enemy’s Counter can kill your own unit.', sources: ['S10'] },
];
